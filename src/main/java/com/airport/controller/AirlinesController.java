...
public class AirlinesController {
	...
	public String DeleteAirlines (@PathVariable("id") String id) {
		Airlines airlines = airlinesRepository.findById (Long.valueOf (id))
		                                      .orElseThrow (() -> new EntityNotFoundException (Airlines.class, id));
		airlinesRepository.deleteAirlines (airlines);
		return id;
	}
	...
	@PutMapping(value = "/{id}")
	@Transactional
	public ResponseEntity<Airlines> updateAirlines (@PathVariable("id") String id, @RequestBody @Valid AirlinesUpdateRequest AirlinesUpdateRequest) {
