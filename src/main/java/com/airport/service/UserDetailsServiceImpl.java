	...
	public UserDetails loadUserByUsername (String login) throws UsernameNotFoundException {
		try {
			...
			if (passengers.getId () == null) {
				...
				return new org.springframework.security.core.userdetails.User (passengers.getLogin (), passengers.getPassword (), AuthorityUtils.commaSeparatedStringToAuthorityList (roles.get (0)
				                                                                                                                                                                           .getRole ()));
			}
		} catch (Exception e) {
