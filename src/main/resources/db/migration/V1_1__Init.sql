...
alter table if exists airlines
    add constraint airline_country_fk foreign key (country_id) references countries
        on update cascade on delete cascade;

alter table if exists airplanes
    add constraint airplanes_country_fk foreign key (country_id) references countries
        on update cascade on delete cascade;

alter table if exists airports
    add constraint airports_country_fk foreign key (country_id) references countries
        on update cascade on delete cascade;
...
alter table if exists passengers
    add constraint passengers_country_fk foreign key (country_id) references countries
        on update cascade on delete cascade;
